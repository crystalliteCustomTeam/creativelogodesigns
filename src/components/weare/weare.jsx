                        ...
                        <div className="basis-full">
                            ...
                            <div className="flex lg:divide-x lg:divide-red mb-10 lg:mb-20 gap-5 flex-wrap lg:flex-nowrap justify-center">
                                <div className="basis-[46%] md:basis-[30%] lg:basis-1/5">
                                    <Image src={one} alt={one} className="block m-auto mb-3" proprity="true" quality="70" />
                                    <h3 className="text-basis md:text-lg xl:text-xl font-light font-sans text-black text-center">
                                        Creative Excellence
                                    </h3>
                                </div>
                                <div className="basis-[46%] md:basis-[30%] lg:basis-1/5">
                                    <Image src={two} alt={two} className="block m-auto mb-3" proprity="true" quality="70" />
                                    <h3 className="text-basis md:text-lg xl:text-xl font-light font-sans text-black text-center">
                                        Customized Solutions
                                    </h3>
                                </div>
                                <div className="basis-[46%] md:basis-[30%] lg:basis-1/5">
                                    <Image src={three} alt={three} className="block m-auto" proprity="true" quality="70" />
                                    <h3 className="text-basis md:text-lg xl:text-xl font-light font-sans text-black text-center">
                                        Responsive Design
                                    </h3>
                                </div>
                                <div className="basis-[46%] md:basis-[30%] lg:basis-1/5 border-l-5">
                                    <Image src={four} alt={four} className="block m-auto mb-3" proprity="true" quality="70" />
                                    <h3 className="text-basis md:text-lg xl:text-xl font-light font-sans text-black text-center">
                                        On-Time Delivery
                                    </h3>
                                </div>
                                <div className="basis-[46%] md:basis-[30%] lg:basis-1/5">
                                    <Image src={five} alt={five} className="block m-auto mb-3" proprity="true" quality="70" />
                                    <h3 className="text-basis md:text-lg xl:text-xl font-light font-sans text-black text-center">
                                        Affordable Pricing.
                                    </h3>
                                </div>
                            ...
                            <div className="flex border-2 rounded-2xl border-red items-center justify-evenly py-5 flex-wrap md:flex-nowrap text-center md:text-left flex-col md:flex-row gap-5">
                                ...
                                <div className="basis-full md:basis-[30%]">
                                    <Link href="tel:3476073636" className="text-xl lg:text-2xl font-medium font-sans text-black">
                                        Call Us (TOLL FREE) <br /> (347) 607-3636
                                    </Link>
                                </div>
                                <div className="basis-full md:basis-[30%]">
