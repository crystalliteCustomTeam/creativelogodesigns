                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-x-10 gap-y-5">
                        <div>
                            <div className=" mb-10">
                                ...
                                <span className="block w-[10%] h-[4px] bg-[#cbdaff] mt-3 mb-3"></span>
                            ...
                            <form autoComplete="off" spellCheck="false" className="grid gap-5 grid-cols-1">
                                ...
                                <div className="w-[180px]">
                                    <Button
                                        text={formStatus}
                                        css="font-poppins !inline-flex !items-center !transition-colors !text-[18px] !font-semibold !leading-tight !bg-yellow-500 !text-black !h-[50px] !px-5 !hover:bg-[#cbdaff] !rounded-[0_15px_15px_15px]"
                                        disabled={isDisabled}
