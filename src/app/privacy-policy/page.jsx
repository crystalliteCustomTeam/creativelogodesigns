            ...
            <section>
                <div className="py-[50px]">
                    <div className="container">
                        ...
                        <p className="text-[15px] leading-[25px] text-[#565151] font-normal mb-2">
                            We use cookies to help us remember, understand and save your preferences for future visits and compile aggregate data about site traffic and site interaction so that we can offer better site experiences and tools in the future. This information is collected in an anonymous form that includes no personally identifiable information. No personally identifiable information is collected on this website unless that information is explicitly submitted via a fill-in form. For example, an email address submission is requested in order to Work With Us on <Link href="https://www.creativelogodesigns.us/" className="text-[#0F2847] font-bold">https://www.creativelogodesigns.us/</Link> and users will have the option to provide this information or not.
                        </p>
                        <p className="text-[15px] leading-[25px] text-[#565151] font-normal mb-5">
                            This anonymous information generated by cookies is transmitted to Google where it is processed to generate anonymous, aggregate reporting on website activity strictly for the domain <Link href="https://www.creativelogodesigns.us/" className="text-[#0F2847] font-bold">https://www.creativelogodesigns.us/</Link>. These reports are used to gain insight on how best to optimize the user experience, content, and marketing at <Link href="https://www.creativelogodesigns.us/" className="text-[#0F2847] font-bold">https://www.creativelogodesigns.us/</Link>.
                        </p>
                        <h2 className="text-xl sm:text-2xl font-sans text-[#202020] font-semibold leading-none mb-2">
                        ...
                        <p className="text-[15px] leading-[25px] text-[#565151] font-normal mb-5">
                            Please also visit our Terms and Conditions section establishing the use, disclaimers, and limitations of liability governing the use of our website at <Link href="https://www.creativelogodesigns.us/" className="text-[#0F2847] font-bold">www.creativelogodesigns.us</Link>
                        </p>
                        <h2 className="text-xl sm:text-2xl font-sans text-[#202020] font-semibold leading-none mb-2">
                            Your Consent
                        </h2>
                        ...
                        <p className="text-[15px] leading-[25px] text-[#565151] font-normal mb-5">
                            You have the right to request details of the personal information we hold about you. If you would like a copy of this information, please contact us at <a href="mailto:info&#64;creativelogodesigns&#46;us" className="text-[#0F2847] font-bold">info&#64;creativelogodesigns&#46;us</a>
                        </p>
                        <h2 className="text-xl sm:text-2xl font-sans text-[#202020] font-semibold leading-none mb-2">
                        ...
                        <p className="text-[15px] leading-[25px] text-[#0F2847] font-bold mb-5">
                            <Link href="/">www.creativelogodesigns.us</Link>
                        </p>
                        <h3 className="text-lg sm:text-xl font-sans text-[#202020] font-semibold leading-none mb-2">
                            Address:
                        </h3>
                        ...
                        <p className="text-[15px] leading-[25px] text-[#0F2847] font-bold mb-5">
                            <a href="mailto:info&#64;creativelogodesigns&#46;us">info&#64;creativelogodesigns&#46;us</a>
                        </p>
                        <h3 className="text-lg sm:text-xl font-sans text-[#202020] font-semibold leading-none mb-2">
                            Phone:
                        </h3>
