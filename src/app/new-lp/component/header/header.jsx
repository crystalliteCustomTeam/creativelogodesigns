        ...
        <>
            <section className={`${styles.post} font-poppins relative`}>
                <div class="container mx-auto lg:py-5 font-secondary">
                    <div class="md:grid md:grid-cols-2 sm:grid-cols-1 md:justify-between md:items-center sm:justify-center">
                        <Image src={One} class='w-48' />

                        <div class='flex gap-8 items-center md:justify-end sm:justify-start sm:pt-5 pt-5'>
