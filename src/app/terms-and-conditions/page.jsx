                ...
                <div className="py-[50px]">
                    <div className="container">
                        ...
                        <ul className="list-disc list-inside mb-5">
                            <li className="text-[14px] leading-[28px] text-[#565151] font-normal mb-2">
                                ...
                                <ul className="list-decimal list-inside pl-5">
                                    ...
                                    <li>
                                        <span>
                                            <a href="mailto:info&#64;creativelogodesigns&#46;us" className="text-[#0F2847]">info&#64;creativelogodesigns&#46;us</a>
                                        </span>
                                    </li>
                                </ul>
                            </li>
                        ...
                        <ul className="list-disc list-inside mb-5">
                            <li className="text-[14px] leading-[28px] text-[#565151] font-normal mb-2">
                                <span>
                                    Emails Sent back and forth through official emails that are "<a href="mailto:info&#64;creativelogodesigns&#46;us" className="text-[#0F2847]">info&#64;creativelogodesigns&#46;us</a>" are to be only considered forms of valid communication.
                                </span>
                            </li>
                            <li className="text-[14px] leading-[28px] text-[#565151] font-normal mb-2">
                                <span>
                        ...
                        <p className="text-[15px] leading-[25px] text-[#565151] font-normal">
                            if you have any questions or concerns regarding this policy, please contact us at <a href="mailto:info&#64;creativelogodesigns&#46;us" className="text-[#0F2847] font-bold">info&#64;creativelogodesigns&#46;us</a>
                        </p>
                    </div>
                </div>
            </section>
