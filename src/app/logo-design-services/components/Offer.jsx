...
const Offer = () => {
    ...
    return (
                ...
                <div className="container md:max-w-6xl lg:max-w-6xl">
                    <div className="grid grid-flow-row grid-cols-1 items-center py-16 pb-0">
                        <div className="border-[#f73600] border-l-[13px] border-solid">
                           <div className="px-4">
                            <h4 className="text-3xl leading-9 text-[#212529]">A WIDE RANGE OF</h4>
                            <h2 className="text-[50px] font-bold leading-tight text-[#212529]">Logo Designs We Offer</h2>
        ...
        <section className="font-poppins py-5 cusmslide">
                    ...
                    <Slider {...sliderSettings1}>
                        <div className="bg-[#23bbc8] hover:bg-[#f73600] px-[23px] py-[23px]">
                            <span className="flex">
                                ...
                                <h4 className="text-[#fff] font-semibold text-[18px] pl-4">ICONIC <br /> LOGO</h4>
                        ...
                        <div className="bg-[#23bbc8] hover:bg-[#f73600] px-[23px] py-[23px]">
                            <span className="flex ">
                                ...
                                <h4 className="text-[#fff] font-semibold text-[18px] pl-4">TYPOGRAPHIC <br /> LOGO</h4>
                        ...
                        <div className="bg-[#23bbc8] hover:bg-[#f73600] px-[23px] py-[23px]">
                            <span className="flex ">
                                <Image src="/logodesignnew/design.webp" alt="T" className="w-[57px] h-[56px]" width={56} height={57}/>
                                <h4 className="text-[#fff] font-semibold text-[18px] pl-4">ILLUSTRATIVE <br /> LOGO</h4>
                        ...
                        <div className="bg-[#23bbc8] hover:bg-[#f73600] px-[23px] py-[23px]">
                            <span className="flex ">
                                <Image src="/logodesignnew/illustration.webp" alt="T" className="w-[57px] h-[56px]" width={56} height={57}/>
                                <h4 className="text-[#fff] font-semibold text-[18px] pl-4">ANIMATED <br /> LOGO</h4>
            ...
            <a href="/" class="bg-[#f73600] uppercase text-[#fff] flex items-center gap-3 justify-center text-[13px] w-[280px] py-3 rounded-full transition-all"><span class="text-[14px] font-medium"> REQUEST A QUOTE</span></a>
            </div>
        </section>
        <hr />
