        ...
        <footer className="font-poppins">
            <div className="bg-[#060f32] text-white pt-10 pb-5">
                <div className="container max-w-6xl">
                    <div className="grid grid-flow-row lg:grid-cols-3 xl:grid-cols-3 items-center gap-x-3 mb-10 pb-4 border-[#aeaeae] border-b-[2px] border-solid sm:grid-cols-1 sm:text-center sm:justify-center">
                        <div className="text-[14px] font-light px-8 ">
                           <Link href="/" className="px-2">Terms & Conditions</Link> <span className="h-[50px] w-1">|</span> <Link href="/"  className="px-2">Privacy Policy</Link>
                        </div>
                        <div className="text-white text-[12px]">
                            <p>Copyright © 2023 The Design Verse | All rights reserved.</p>
                        </div>
                        <div className="">
                            <Image src="/logodesignnew/footer-card-icon.webp" height={77} width={334} className="w-[334] h-[77] sm:mx-auto"/>
                        </div>
                    </div>
                    <div className="text-center border-top-2 ">
                        <h4 className="font-semibold text-[18px] pb-3 text-[#f73600]">Disclaimer:
</h4>
                        <p className="text-[11px]">The logo, name and graphics of The Design Verse and its products & services are the trademarks of The Design Verse. All other company names, brand names, trademarks and logos mentioned on this website are the property of their respective owners and do not constitute or imply endorsement, sponsorship or recommendation thereof by The Design Verse vand do not constitute or imply endorsement, sponsorship or recommendation of The Design Verse by the respective trademark owner.
