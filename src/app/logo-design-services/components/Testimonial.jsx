        ...
        <section className="font-poppins py-5 testimonials">
                <div className="container md:max-w-6xl lg:max-w-6xl">
                    <div class="grid grid-flow-row grid-cols-1 items-center gap-x-3 mb-10">
                        <h2 class="text-[30px] text-center pt-10 text-[#060f32] font-extrabold">Have a Look at What we have Designed Throughout the years</h2><p class="text-[16px] text-[#74767d] text-center">We take an integrated approach to creating highly engaging digital properties &amp; brand focused creative solutions. We believe in providing highly creative and exclusive logo designs that give an edge over your competitors.</p>
                   
                    </div>
                    <div className="grid grid-flow-row grid-cols-1 items-center gap-5 py-0 relative">
                      <Slider {...sliderSettings1}>
                        <div className="text-center bg-[#f7f7f7] p-4">
                            <Image  src="/logodesignnew/client1.webp" width={134} height={118} className="relative mt-[-40px] w-[134px] h-[118px] mx-auto"/>
                            <div className="py-4">
                                    ...
                                    <h4 className="font-bold pt-5 text-[22px] text-[#161e3f]">Sarah Parker</h4>
                            </div>
                        </div>
                        <div className="text-center bg-[#f7f7f7] p-4">
                            <Image  src="/logodesignnew/client2.webp" width={134} height={118} className="relative mt-[-40px] w-[134px] h-[118px] mx-auto"/>
                            <div className="py-4">
                                    <p className="text-[#757575] text-[14px]"> 
...
</em></p><h4 className="font-bold pt-5 text-[22px] text-[#161e3f]">Mark Andrews
</h4>
                            </div>
                        </div>
                        <div className="text-center bg-[#f7f7f7] p-4">
                            <Image  src="/logodesignnew/client3.webp" width={134} height={118} className="relative mt-[-40px] w-[134px] h-[118px] mx-auto"/>
                            <div className="py-4">
                                    <p className="text-[#757575] text-[14px]"> 
                                    ...
                                    <h4 className="font-bold pt-5 text-[22px] text-[#161e3f]">Julia Schmidt
</h4>
                            </div>
                        </div>
                      </Slider>
